...
class Options():
    def __init__(self):
        ...
        self.parser.add_argument('--source', type=str, default='Gastroscopy_Data', help='Source type')
        self.parser.add_argument('--target', type=str, default='Capsule_Data/An_Han', help='target type')
        ...
        ## data loader related
        self.parser.add_argument('--train_dataroot', type=str, default='/home/ltb/dataset/', help='path of train data')
        self.parser.add_argument('--test_dataroot', type=str, default='/home/ltb/dataset/', help='path of test data')
        ...
        self.parser.add_argument('--epochs_down', type=int, default=100, help='number of epochs for training downsampling')
        ...
        self.parser.add_argument('--epochs_sr_end', type=int, default=100, help='end epochs for training SR')
        self.parser.add_argument('--lr_sr', type=float, default=0.0001, help='learning rate for training SR')
        ...
        self.parser.add_argument('--wav_w', type=float, default=0.0, help='weight for wavelet loss in esrgan training')
        ...
        self.parser.add_argument('--sr_model', type=str, choices=('edsr', 'rrdb', 'endosr'), default='edsr', help='choose model to SR')
        self.parser.add_argument('--training_type', type=str, default='edsr', choices=('edsr', 'esrgan', 'endosr'), help='choose training type of SR')
...
class TestOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--resume_sr', type=str, default=None, help='load training states for resume the downsampling learning')
        self.parser.add_argument('--sr_model', type=str, choices=('edsr', 'rrdb', 'endosr'), default='edsr', help='choose model to SR')
        self.parser.add_argument('--training_type', type=str, default='edsr', choices=('edsr', 'rrdb', 'endosr'), help='choose training type of SR')
        self.parser.add_argument('--precision', type=str, choices=('single', 'half'), default='singe', help='precision for forwarding SR')
        self.parser.add_argument('--realsr', action='store_true', help='just make SR image without calculating PSNR')
        self.parser.add_argument('--chop', action='store_true', help='enable memory-efficient forward')

...
def get_data_loss(img_s, img_gen, data_loss_type, down_filter, args):
    ...
    if data_loss_type == 'adl':
        if down_filter is not None:
            ...
            down_filtered_img_s = F.interpolate(filtered_img_s, scale_factor=1/args.scale, mode='nearest', recompute_scale_factor=False)
        ...
        hr_filter = nn.AvgPool2d(kernel_size=args.box_size * args.scale, stride=args.box_size * args.scale)
